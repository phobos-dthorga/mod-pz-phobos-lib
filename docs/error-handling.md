...
Reusable PZ widget helpers for building tabbed views, status badges, and collapsible rows within the ISPanel/ISButton system. All callback invocations use `PhobosLib.safecall`. Added in v1.60.0.
